...
<html>
	...
	<body class="claro">
		<p> <a href="/cbsatesting/Performance/SaaSEvaluation.jsp"> SaaS Evaluation </a> > <a href="../PerformanceValidation.jsp"> Performance Validation </a> > <a href="../PerformanceMetrics.jsp"> Performance Measurements </a> > Create Metric </p>
		...
		<form name="createmetric" id="createmetric" method="post">
			<table class="createmetric">
				...
				<tr>
					<td> Equation: </td> 
					<td> 
						Coefficient 1: <input type="text" name="coefficient1" id="coefficient1" size="5" maxlength="5" value="<% if(request.getParameter("coefficient1") != null) out.print(request.getParameter("coefficient1")); %>" />
						<br />
						Metric 1: 
						<select name="metric1" id="metric1">
							<%	try {
								...
								resultset = statement.executeQuery("Select distinct name from performancemetric where type = 'System Defined' or type = 'User Defined'");
						...
						<br />
						<br />
						Coefficient 2: <input type="text" name="coefficient2" id="coefficient2" size="5" maxlength="5" value="<% if(request.getParameter("coefficient2") != null) out.print(request.getParameter("coefficient2")); %>" />
						<br />
						Metric 2:
