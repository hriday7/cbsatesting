...
<html>
	...
	<body class="claro">
		<p> <a href="/cbsatesting/Performance/SaaSEvaluation.jsp"> SaaS Evaluation </a> > <a href="../PerformanceValidation.jsp"> Performance Validation </a> > <a href="../PerformanceMetrics.jsp"> Performance Measurements </a> > Metric Details </p>
		<% String paramname = request.getParameter("Name");
		%>		
		<h2>Metric Details: <%= paramname %></h2>
		...
		<% 
			try {
				...
				resultset = statement.executeQuery("Select * from PerformanceMetric where Name = '" + paramname + "' and Statistic = '" + request.getParameter("Statistic") + "'" );
				if (resultset.next())
				{ 
		%>
		...
		<form name="displaymetric" id="displaymetric" method="post">
			...
			<%
				...
				{
					//out.println("MNJ this is from DisoayMetrics.jsp");
