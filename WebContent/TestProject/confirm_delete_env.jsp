...
%>
 <%
	String secretkey="wye9KJ3vioi4MP8uDwBKy0Q/J9fNRciW8CM+EU5A"; // MNJ - added new secretkey wye9KJ3vioi4MP8uDwBKy0Q/J9fNRciW8CM+EU5A";
	String accesskey="AKIAIMEH6LATDIR5P6IA";   //MNJ replaced old accesskey to new one
